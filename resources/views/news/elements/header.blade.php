                ...
                case 'category_article':
                    ...
                    if (count($itemsCategory) > 0) {
                        ...
                        foreach ($itemsCategory as $itemCategory) {
                            ...
                            $xhtmlMenu .= sprintf('<li><a href="%s" target="%s" data-parent="category_article">%s</a></li>', $linkCategory, $target, $itemCategory['name']);
                            $xhtmlMenuMobile .= sprintf('<li class="menu_mm"><a href="%s" target="%s">%s</a></li>', $linkCategory, $target, $itemCategory['name']);
                        }
